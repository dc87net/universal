...
# ══ ZETA ══════════════════════════════════════════════════════════════════════
# Custom symbolic zeta function method corrected along the critical line
def zeta_symbolic(t):
    """
    Computes the Riemann zeta function along the critical line Re(s) = 0.5.
    """
    return (2 ** (0.5 - 1j * t) * pi ** (-(0.5 + 1j * t)) *
            cmath.sin(pi * (0.5 + 1j * t) / 2) *
