...
ax.plot(t_values, real_parts, zs=0, zdir='z', label='Real Part', color='blue')

# Plot the imaginary part of the wave function
ax.plot(t_values, imag_parts, zs=0, zdir='y', label='Imaginary Part', color='green')

# Customize the axes labels and title
ax.set_xlabel('Time (t)')
ax.set_ylabel('Imaginary Part')
ax.set_zlabel('Real Part')
ax.set_title('3D Visualization of Custom Zeta Function as a Wave Function')
