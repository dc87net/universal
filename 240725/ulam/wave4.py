...
# Plot the real part of the wave function in polar coordinates with color mapping
ax.plot(theta, r, z_real, label='Real Part', color='blue')

# Plot the imaginary part of the wave function in polar coordinates with color mapping
...
ax.set_title('3D Radial Visualization of Custom Zeta Function with Amplitude Color Mapping')
