...
plt.plot(t_values, imaginary_numerical, label='Numerical Imaginary Part', linestyle='--', color='blue')

# Plot symbolic results
plt.plot(t_values, real_symbolic, label='Symbolic Real Part', color='red', alpha=0.7)
